...
const COMPUTER_USE_APP = join(CODEX_HOME, "computer-use/Codex Computer Use.app");
const SERVICE_PATH = join(COMPUTER_USE_APP, "Contents/MacOS/SkyComputerUseService");
...
const READ_ONLY_AUTO_RECOVERY_TOOLS = new Set(["list_apps", "get_app_state", "event_stream_status", "computer_history_status", "computer_history_get_settings"]);
